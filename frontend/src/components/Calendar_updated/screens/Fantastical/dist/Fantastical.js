...
exports.Fantastical = function () {
    ...
    var getColorClasses = function (color) {
        ...
        return colorMap[color] || colorMap.lightblue;
    };
    return (React.createElement("div", { className: "bg-white flex flex-row justify-center w-full" },
        React.createElement("div", { className: "bg-white w-full relative flex" },
            React.createElement("div", { className: "flex-grow relative" },
                React.createElement(CalendarSection_1.CalendarSection, null),
                calendarEvents.map(function (event) { return (React.createElement(DraggableEvent_1.DraggableEvent, { key: event.id, event: event, getColorClasses: getColorClasses })); })))));
};
