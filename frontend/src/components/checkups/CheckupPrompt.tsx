          ...
          {checkupContext ? (
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-2 text-xs text-muted-foreground">
                ...
                <div className="rounded-lg border border-border bg-muted px-3 py-2">
                  <p className="font-medium text-foreground">Done today</p>
                ...
                <div className="mt-2 grid grid-cols-1 gap-2 sm:grid-cols-2">
                  <div className="rounded-lg bg-muted px-2.5 py-2">
                    ...
                    {checkupContext.topGoals.length > 0 ? (
                      ...
                      <p className="mt-1 text-muted-foreground">No goals set yet.</p>
                    )}
                  </div>

                  <div className="rounded-lg bg-muted px-2.5 py-2">
                    <p className="font-medium text-foreground">What you are focusing on</p>
                    {focusTasks.length > 0 ? (
                      <ul className="mt-1 space-y-1 text-muted-foreground">
