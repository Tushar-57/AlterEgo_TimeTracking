...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // pointer-events-none is the important part: this container is fixed,
      // full width and padded, so without it the empty space around a toast
      // swallows every tap in that strip — and on mobile that strip sits over
      // the controls. Each toast re-enables pointer events for itself.
