...
@Embeddable
public class PlannerAvailabilityEntity {
    @Column(name = "work_hours_start", insertable = false, updatable = false)
    private String workHoursStart;

    @Column(name = "work_hours_end", insertable = false, updatable = false)
    private String workHoursEnd;

    @Column(name = "dnd_hours_start", insertable = false, updatable = false)
    private String dndHoursStart;

    @Column(name = "dnd_hours_end", insertable = false, updatable = false)
    private String dndHoursEnd;

    @Column(name = "check_in_preferred_time", insertable = false, updatable = false)
    private String checkInPreferredTime;

    @Column(name = "check_in_frequency", insertable = false, updatable = false)
    private String checkInFrequency;

    @Column(name = "timezone", insertable = false, updatable = false)
    private String timezone;

    public PlannerAvailabilityEntity() {}
    public PlannerAvailabilityEntity(String workHoursStart, String workHoursEnd, String dndHoursStart, String dndHoursEnd,
